...
def image_prossing(ornage_data, grapefruit_data, kanpei_data, dekopon_data):
    ...
    for i in kanpei:
        ...
        kanpei_img_resize.save(
            f"./dataset/image/kanpei/kanpei_{file_name}.png")
    ...
    for i in grapefruit:
        ...
        grapefruit_img_resize.save(
            f"./dataset/image/grapefruit/grapefruit_{file_name}.png")
    ...
    for i in ornage:
        ...
        orange_img_resize.save(f"./dataset/image/orange/orange_{file_name}.png")
