...
cv2.rectangle(mask, (60,50),(280, 280), (255,255,255), -1) #첫번째 사각형
cv2.rectangle(mask, (420,50),(550,230), (255,255,255), -1) #두번째 사각형
cv2.rectangle(mask, (750,50),(920,280), (255,255,255), -1) #세번째 사각형
cv2.imshow("...",mask)
cv2.waitKey(0)